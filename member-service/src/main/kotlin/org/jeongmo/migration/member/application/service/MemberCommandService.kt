...
class MemberCommandService(
    ...
    private val logger = LoggerFactory.getLogger(MemberCommandService::class.java)

    override fun createMember(request: CreateMemberRequest): CreateMemberResponse {
        if (request.providerType == ProviderType.LOCAL && request.password == null) throw MemberException(
