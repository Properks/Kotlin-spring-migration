...
interface ItemCommandUseCase {
     ...
     * @return 생성된 상품의 데이터
     */
    fun createItem(ownerId: Long, request: CreateItemRequest): CreateItemResponse
     ...
     */
    fun decreaseItemCount(itemId: Long, request: DecreaseItemStockRequest)
     ...
     * @throws ItemException 상품을 찾지 못한 경우
     */
    fun increaseItemCount(itemId: Long, request: IncreaseItemStockRequest)
     ...
     *
     */
    fun updateItem(ownerId: Long, itemId: Long, request: UpdateItemRequest): UpdateItemResponse
     ...
     */
    fun deleteItem(ownerId: Long, itemId: Long)
}